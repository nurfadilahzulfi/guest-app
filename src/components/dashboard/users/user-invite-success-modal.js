...
import { IconCheck, IconMail, IconCopy } from "@/components/icons/guest-icons";

/**
 * Modal sukses setelah user baru berhasil diundang.
 * @param {Object} props
 * @param {Object|null} props.data - {name, email, rawPassword, loginUrl, inviteUrl}
 * @param {function(): void} props.onClose
 */
export function UserInviteSuccessModal({ data, onClose }) {
  if (!data) return null;
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-xs animate-fadeIn">
      <div className="bg-white rounded-3xl shadow-2xl border border-zinc-200 max-w-md w-full p-6 space-y-4 animate-scaleIn">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-base font-bold text-zinc-900">Akun Pengguna Berhasil Dibuat!</h3>
