...
/**
 * Ikon perisai centang (keamanan SSL / proteksi enkripsi).
 * @param {{ className?: string }} props
 */
...
/**
 * Ikon dashboard / grid beranda.
 * @param {{ className?: string }} props
 */
export function IconLayoutDashboard({ className = "w-5 h-5" }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
...
/**
 * Ikon grup pengguna sistem (User Management).
 * @param {{ className?: string }} props
 */
export function IconUsersGroup({ className = "w-5 h-5" }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
...
/**
 * Ikon filter / corong penyaring data.
 * @param {{ className?: string }} props
 */
...
/**
 * Ikon rotasi berlawanan jarum jam / ambil ulang foto / switch kamera.
 * @param {{ className?: string }} props
 */
export function IconRotateCcw({ className = "w-5 h-5" }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
...
/**
 * Ikon kunci / reset kata sandi.
 * @param {{ className?: string }} props
 */
export function IconKey({ className = "w-5 h-5" }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
      <path d="m21 2-2 2m-1.5 1.5L14 9M3 21l9-9M9 3a6 6 0 1 0 8.49 8.49L7.5 21.5 2.5 21.5 2.5 16.5 12.5 6.5" />
    </svg>
  );
}

/**
 * Ikon pensil / edit dokumen.
 * @param {{ className?: string }} props
 */
...
/**
 * Ikon unduh / ekspor data (download/export).
 * @param {{ className?: string }} props
 */
